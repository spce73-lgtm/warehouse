...
// >>> افزوده شد: نسخه‌ی کش به v10 ارتقا یافت — این‌بار به‌خاطر: ۱) چسبناک/فریزشدنِ هدر بالا،
// نوار جست‌وجو/دکمه‌ی کالاهای باقیمانده، و عنوان ستون‌های جدول در هر سه فهرست (قفسه‌ها،
// کالاهای باقیمانده، نتایج جست‌وجو) هنگام اسکرول؛ ۲) رفع ریشه‌ای نمایشِ «آخرین شمارش» در
// نتایج جست‌وجو (اکنون از تاریخ واقعیِ بدون‌محدودیت‌زمانی استفاده می‌شود و برای کالاهای
// واقعاً شمارش‌نشده «بدون سابقه شمارش» نشان داده می‌شود). بدون این تغییر نام کش، PWAهای از
// قبل نصب‌شده همچنان index.html/app.js/style.css نسخه‌ی v9 (بدون این اصلاحات) را از کش
// می‌بینند.
var CACHE_NAME = 'wh-scanner-shell-v10';
