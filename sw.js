...
// >>> افزوده شد: نسخه‌ی کش به v9 ارتقا یافت — این‌بار به‌خاطر افزودن «فهرست کالاهای
// باقیمانده» (زیر نوار جست‌وجو) و نمایش «آخرین شمارش» در نتایج جست‌وجو. بدون این تغییر نام
// کش، PWAهای از قبل نصب‌شده همچنان index.html/app.js/style.css نسخه‌ی v8 (بدون این قابلیت‌ها)
// را از کش می‌بینند.
var CACHE_NAME = 'wh-scanner-shell-v9';
